pipeline {
     ...
     environment {
       DOCKERHUB_CREDENTIALS=credentials('13cd9e044e53-dockerhub-token')
       ...
       AWS_S3_BUCKET = 'abdullah-docker'
       AWS_EB_APP_NAME = 'abdullah-belt2-artifacts-123456'
           AWS_EB_ENVIRONMENT_NAME = 'Abdullahbelt2artifacts123456-env'
